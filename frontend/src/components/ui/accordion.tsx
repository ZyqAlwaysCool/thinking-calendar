...
export const AccordionTrigger = ({ className, children, ...props }: AccordionPrimitive.AccordionTriggerProps) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      className={cn(
        'flex flex-1 items-center justify-between py-3 text-left text-sm font-medium text-gray-700 transition-colors duration-150 hover:text-gray-950 dark:text-gray-200 dark:hover:text-gray-50',
        className
      )}
      {...props}
    >
