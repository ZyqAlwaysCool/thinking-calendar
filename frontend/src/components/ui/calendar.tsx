...
export const Calendar = ({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) => (
  <DayPicker
    ...
    classNames={{
      ...
      nav_button:
        'inline-flex h-8 w-8 items-center justify-center rounded-lg text-gray-700 hover:bg-gray-100 transition-all duration-200 hover:scale-105 dark:text-gray-100 dark:hover:bg-gray-900',
      head_row: 'grid grid-cols-7 text-center text-xs text-gray-300',
      head_cell: 'py-1',
      row: 'grid grid-cols-7 text-center',
      cell: 'relative p-1 text-sm',
      day: 'h-10 w-10 rounded-lg text-gray-700 transition-all duration-200 hover:bg-gray-100 hover:scale-105 dark:text-gray-50 dark:hover:bg-gray-900',
